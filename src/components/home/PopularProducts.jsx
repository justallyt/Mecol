  ...
  return (
    <div className="popular-products">
              <div className="popular-intro">
                        ...
                        <p>Explore the top picks in industrial and corporate furniture at Mecol! From ergonomic office setups to heavy-duty industrial workstations, our best-selling pieces are designed for durability, functionality, and style. Whether you&apos;re outfitting a modern workspace or upgrading your facility, these favorites deliver the quality and performance you need.</p>
              </div>

              <div className="popular-products-row">
                        { popular_products.map(item=>
                              <div className="popular-moja" key={item}>
